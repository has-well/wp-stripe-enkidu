=== WordPress Stripe Donation and Payment Plugin ===
Contributors: mhmrajib, hmplugin, freemius
Donate link: https://www.paypal.me/mhmrajib
Tags: charity, donate, donation, donations, stripe, payment, payments, payment gateway, donation form, payment form, accept payment, best payment plugin, best donation plugin, free donation plugin, free payment gateway plugin, collect donation, collect payment
...
WordPress Stripe Donation is the Best Donation Plugin for WordPress allows you to collect donation or payment on your website via Stripe payment gateway method.

== Description ==

[__Live Demo__](https://stripedonation.com/demo/) | [__Upgrade to Pro!__](https://stripedonation.com/pricing-faq/) | [__Live Chat__](https://stripedonation.com/) | [__Support__](https://stripedonation.com/contact/)

[youtube https://youtu.be/IGjaOmKJ4L4]

= Overview =

**Stripe Donation** is the **Best Donation Plugin for WordPress** allows you to collect donation or payment on your website via Stripe payment gateway method.

You can place a Donation/Payment form in any page where you want to collect money. Donors/Buyers can use their Stripe account or Credit Card to donate money or payment to you.

What makes this [WordPress Stripe Donation and Payment](https://stripedonation.com/) plugin powerful is its usability. After installation and some quick settings, donors from around the world can start donating to you via Stripe.

This Stripe Donation is a simple, effective and powerful plugin you can trust.

<strong> How donation/payment form works!: </strong>
...
* Set Form Width
* 3 Form Header Options
* Form Button Width
* Form Border Width, Color, Radius
* Form Padding, Font Color, Background Color
* Form Input Border Width, Color, Radius
* Form Input Font Color and Size
* Form Input Padding
* Form Input Background Color Option
* Display Total Donation Today
* Form Button Background, Font Color
* Display Donor List Shortocode
* Donor Comments Field
* Address fields Option
* Enable disable receipt email from stripe


[Get the pro](https://stripedonation.com/pricing-faq/)
...
1. Download the latest version of WP Stripe Donation(.zip file)
2. In your Admin, go to menu Plugins > Add New
3. Select "Upload Plugin"
4. Click on "Choose File"
5. Select downloaded wp-stripe-donation.zip and click on "Install Now" button
...
1. Donation/Payment Form Minimal
2. Donation/Payment Form Max
3. SCA supports for European customers
4. General Page Settings Panel
5. Donation/Payment Form Settings Panel
6. Customizable Receipt Email Seetings Panel
